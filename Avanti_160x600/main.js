...
function initAd() {
  ...
  tl.addLabel("frame1", "")
    ...
    .to('#greenBorder_box2', 6.6, { x:0,y:-490, ease: Power1.easeInOut }, "frame1")
    .to('#textMain', 8, { x:0,y:-508, ease: Power1.easeInOut }, "frame1")
    .to('#copy2', 1, { opacity:1,ease: Power1.easeIn }, "frame1+=1.2")
    ...
    .to('#orangeStripContainer', 5, {y:-501, ease: Power1.easeInOut}, "frame1+=2")
